...
public class Notizie extends ListActivity implements OnScrollListener {
	...
	private static String url = "http://lurinews.altervista.org/leggiNotizie.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent i = new Intent(Notizie.this, Notizia.class);
				i.putExtras(cesto);
	...
	class CaricaNotizie extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Notizie.this);
			...
			if (success == 1) {
				...
				runOnUiThread(new Runnable() {
					public void run() {
						...
						ListAdapter adapter = new SimpleAdapter(Notizie.this,
